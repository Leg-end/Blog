...
set $$\bm{w}\to \frac{\bm{w}}{\mathit{\delta}},\ b\to \frac{b}{\mathit{\delta}}\Rightarrow \underset{n}{\mathrm{min}}\left({y}_{n}\cdot\left({\bm{x}}_{n}\right)\right)=1,\ \left|\left|\bm{w}\right|\right|\to \frac{\left|\left|\bm{w}\right|\right|}{\mathit{\delta}}$$
...
-----
**SMO(Sequential Minimal Optimization) algorithm : Solving **$L\left(\bm{a}\right)$  
