...
$$\begin{aligned}P\left(A\right)=\frac{\#\left(\mathrm{A}\right)}{\#\left(\mathit{\Omega}\right)},A\in {2}^{\mathrm{\Omega}},\ \ \#\left(\mathit{\Omega}\right)\ne +\infty ,P\left(\varnothing \right)=0\end{aligned}$$
